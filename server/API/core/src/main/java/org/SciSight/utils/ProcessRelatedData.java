...
public class ProcessRelatedData {
  ...
  public List<RelatedAPI> spaceAPI = Arrays.asList(
      RelatedAPI.builder()
          ...
          .reason(
              "NASA's comprehensive set of APIs provides access to various data related to space exploration, astronomy, and aeronautics, including images, videos, and information about planets, astronauts, and space missions.")
          .build(),
      RelatedAPI.builder()
          .api("Asterank - Asterank Database API")
          .reason(
              "Asterank offers scientific data about asteroids, helping researchers and enthusiasts access information on asteroid sizes, trajectories, and compositions.")
          .build(),
      RelatedAPI.builder()
          .api("Open Notify - Open Notify API")
          .reason(
              "Open Notify provides real-time information on the International Space Station (ISS) location and the astronauts currently in space, supporting space tracking and observation activities.")
          .build(),
      RelatedAPI.builder()
          .api("SpaceX - r/SpaceX API")
          .reason(
              "The r/SpaceX API offers detailed data on SpaceX launches, rockets, capsules, and related space technology, providing insights into private sector space exploration initiatives.")
          .build(),
      RelatedAPI.builder()
          .api("Hubble Heritage - Hubble Heritage project API")
          .reason(
              "This API provides access to a vast collection of images and data captured by the Hubble Space Telescope, supporting astronomers and researchers in their study of the universe.")
          .build());
  ...
  public List<RelatedAPI> climateAPI = Arrays.asList(
      RelatedAPI.builder()
          ...
          .reason(
              "The NOAA API offers comprehensive data on weather conditions, climate trends, and atmospheric patterns, providing valuable insights for climate research and weather forecasting.")
          .build(),
      RelatedAPI.builder()
          .api("EOSDIS - NASA's Earth Observing System Data and Information System API")
          .reason(
              "NASA's EOSDIS API provides access to a wide array of Earth observation data, including climate variables and environmental parameters, supporting the study of climate change and environmental science.")
          .build(),
      RelatedAPI.builder()
          .api("USGS - United States Geological Survey API")
          .reason(
              "The USGS API provides data on natural resources, geology, and natural hazards, which are crucial for understanding and predicting climate-related events and changes.")
          .build(),
      RelatedAPI.builder()
          .api("EPA - Environmental Protection Agency API")
          .reason(
              "EPA's API offers data on air quality, water conditions, and environmental pollutants, facilitating the monitoring and analysis of environmental health and climate change.")
          .build(),
      RelatedAPI.builder()
          .api("NWS - National Weather Service API")
          .reason(
              "NWS API delivers real-time weather alerts and forecasts, helping users prepare for and respond to various weather conditions and climate-related events.")
          .build());
  ...
  public List<RelatedAPI> healthAPI = Arrays.asList(
      RelatedAPI.builder()
          ...
          .reason(
              "The CDC API provides reliable information on various health-related topics, diseases, prevention methods, and more, supporting public health knowledge dissemination and decision-making.")
          .build(),
      RelatedAPI.builder()
          .api("NIH - National Institutes of Health API")
          .reason(
              "The NIH API offers access to a vast repository of health and biomedical research, fostering innovation and facilitating the development of new therapies and treatments.")
          .build(),
      RelatedAPI.builder()
          .api("FDA - Food and Drug Administration API")
          .reason(
              "The FDA API allows users to access data on approved drugs, medical devices, and food products, ensuring compliance with safety standards and regulations.")
          .build(),
      RelatedAPI.builder()
          .api("NLM - National Library of Medicine API")
          .reason(
              "Through the NLM API, users can access extensive resources on medical literature, clinical trials, and health information, supporting healthcare professionals and researchers.")
          .build(),
      RelatedAPI.builder()
          .api("CMS - Centers for Medicare & Medicaid Services API")
          .reason(
              "The CMS API provides information on healthcare coverage, service providers, and reimbursement policies, assisting healthcare institutions and professionals in navigating the healthcare system.")
          .build());
}
